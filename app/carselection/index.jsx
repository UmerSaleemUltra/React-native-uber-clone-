...
export default function CarSelectionScreen() {
  ...
  const carOptions = [
    ...
    { type: 'Ride AC', basePrice: 150, perKmRate: 25, icon: 'airline-seat-recline-extra' },
    { type: 'Business class', basePrice: 300, perKmRate: 40, icon: 'business-center' },
  ];
  ...
  // Function to save the selected car information to Firestore
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={[
          ...
          !selectedCar && styles.disabledConfirmButton
        ]}
